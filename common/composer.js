...
function getSavingCallbacks(callbacks){
    return {
        ...
        ifOk: function(objJoint, assocPrivatePayloads, composer_unlock){
            ...
            console.log('-----getSavingCallbacks----unit-------', JSON.stringify(objUnit));
...
/*
    ...
    params.paying_addresses pay for byte outputs and commissions// 佣金
*/
...
function filterMostFundedAddresses(rows, estimated_amount){
	...
	console.log('---arrFundedAddresses--',arrFundedAddresses);
